...
import com.messaging.platform.skt.config.SktProperties
...
@Component
class SktApiClient(
    @param:Qualifier("sktWebClient") private val webClient: WebClient,
    @param:Qualifier("sktCircuitBreaker") private val circuitBreaker: CircuitBreaker,
    @param:Qualifier("sktRetry") private val retry: Retry,
    private val config: SktProperties
) {
    ...
    private fun handleResponse(
        ...
        return SmsSendResult.fail(response.resultCode, response.resultMsg)
    }
}
