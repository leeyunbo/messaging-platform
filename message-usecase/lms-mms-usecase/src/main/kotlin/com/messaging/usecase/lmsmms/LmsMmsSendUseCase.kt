 ...
 */
@Service
class LmsMmsSendUseCase(
    private val providerRouter: LmsMmsProviderRouter,
    private val smsRepository: SmsRepository
) {
    private val log = LoggerFactory.getLogger(javaClass)

    private val retry = Retry.of("lms-mms-send", RetryConfig.custom<SmsSendResult>()
        .maxAttempts(3)
    ...
    suspend fun send(request: SmsSendRequest): SmsSendResult {
        ...
        log.info("Processing {} send: messageId={}, recipient={}", msgType, request.messageId, request.recipient)
